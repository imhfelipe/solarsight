...
export function StepDiagnosis({
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-12 print:p-0 font-sans">
      {/* Banner Principal de Previsão Futura Estilo Google Solar Executive Summary */}
        ...
        <div className="flex flex-col sm:flex-row items-start justify-between gap-6 z-10 relative">
          <div className="space-y-3 max-w-2xl">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-orange-100 font-sans flex items-center gap-1">
                ...
                <ProvenanceTooltip sourceText="Inclinação calculada pela latitude geográfica local e azimute baseado no rumo do telhado (Google Solar API & Turf.js)." />
              </span>
            </div>

            <h2 className="text-3xl font-extrabold text-white tracking-tight flex items-center gap-3">
              <Sparkles className="w-8 h-8 text-amber-200" />
              Previsão de Geração Solar Preditiva
            </h2>

            <p className="text-xs sm:text-sm text-orange-50 leading-relaxed">
              Estimativa preditiva de produção de energia futura calculada com base na irradiação solar incidental (POA) pelo modelo Liu-Jordan & Erbs + Google Solar API, inclinada dinamicamente conforme a latitude e escalonada pela placa solar ({panel.brand} {panel.powerWp}Wp).
            </p>
            ...
            <div className="bg-black/20 backdrop-blur-md p-4 rounded-xl border border-white/20 text-xs text-white space-y-1">
              <div className="flex items-center justify-between">
                ...
                <ProvenanceTooltip sourceText="Calculado via irradiação incidentes no plano inclinado (POA), eficiência nominal do painel, Google Solar Building Insights e PR de 80%." />
              </div>
              <p>
          ...
          <Card3D className="bg-white p-5 rounded-2xl border border-orange-200 text-slate-900 shrink-0 w-full sm:w-72 space-y-3 shadow-md">
            <div className="flex items-center justify-between">
              ...
              <ProvenanceTooltip sourceText="Fonte: NASA POWER & Google Solar API (Building Insights)" />
            </div>
